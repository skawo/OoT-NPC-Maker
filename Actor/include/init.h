...
void Setup_Animation(NpcMaker* en, PlayState*playState, int anim_id, bool interpolate, bool play_once, bool force_set, bool do_nothing);
bool Setup_AnimationImpl(Actor* actor, PlayState*playState, SkelAnime* skelanime, int anim_addr, int anim_type, int object, int fileStart, int actor_object, int actor_object_filestart,
