...
bool Setup_AnimationImpl(Actor* actor, GlobalContext*global, SkelAnime* skelanime, int anim_addr, int anim_type, int object, int actor_object,
                          int anim_start, int anim_end, float speed, bool interpolate, bool play_once);
u32 Setup_LoadSection(u32* alloc_dest, u16* entries_number_out, u8* buffer, u32 offset, u32 entry_size, 
                      u32 null_block_size, s32 block_size);
