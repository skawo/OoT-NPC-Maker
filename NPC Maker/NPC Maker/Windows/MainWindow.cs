    ...
    public partial class MainWindow : Form
    {
        ...
        public MainWindow()
        {
            ...
            typeof(Control).InvokeMember("DoubleBuffered",
                ...
                null, DataGrid_Animations, new object[] { DoubleBuffered });

            typeof(Control).InvokeMember("DoubleBuffered",
                BindingFlags.NonPublic | BindingFlags.Instance | BindingFlags.SetProperty,
                null, DataGrid_NPCs, new object[] { DoubleBuffered });

            typeof(Control).InvokeMember("DoubleBuffered",
                BindingFlags.NonPublic | BindingFlags.Instance | BindingFlags.SetProperty,
                null, DataGridView_ExtraDLists, new object[] { DoubleBuffered });

            typeof(Control).InvokeMember("DoubleBuffered",
                BindingFlags.NonPublic | BindingFlags.Instance | BindingFlags.SetProperty,
                null, TabControl, new object[] { DoubleBuffered });
