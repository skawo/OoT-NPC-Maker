...
namespace NPC_Maker
{
    public static class Lists
    {
        ...
        */
        ...
        {
            $"{Instructions.IF}", $"{IfSubTypes.FLAG_INF}", $"{Instructions.IF} {IfSubTypes.FLAG_INF} [Flag_ID] [True/False]", "",
            $"{Instructions.IF}", $"{IfSubTypes.FLAG_EVENT}", $"{Instructions.IF} {IfSubTypes.FLAG_EVENT} [Flag_ID] [True/False]", "",
            $"{Instructions.IF}", $"{IfSubTypes.FLAG_SWITCH}", $"{Instructions.IF} {IfSubTypes.FLAG_SWITCH} [Flag_ID] [True/False]", "",
            $"{Instructions.IF}", $"{IfSubTypes.FLAG_SCENE}", $"{Instructions.IF} {IfSubTypes.FLAG_SCENE} [Flag_ID] [True/False]", "",
            $"{Instructions.IF}", $"{IfSubTypes.FLAG_TREASURE}", $"{Instructions.IF} {IfSubTypes.FLAG_TREASURE} [Flag_ID] [True/False]", "",
            $"{Instructions.IF}", $"{IfSubTypes.FLAG_ROOM_CLEAR}", $"{Instructions.IF} {IfSubTypes.FLAG_ROOM_CLEAR} [Flag_ID] [True/False]", "",
            $"{Instructions.IF}", $"{IfSubTypes.FLAG_SCENE_COLLECT}", $"{Instructions.IF} {IfSubTypes.FLAG_SCENE_COLLECT} [Flag_ID] [True/False]", "",
            $"{Instructions.IF}", $"{IfSubTypes.FLAG_TEMPORARY}", $"{Instructions.IF} {IfSubTypes.FLAG_TEMPORARY} [Flag_ID] [True/False]", "",

            $"{Instructions.IF}", $"{IfSubTypes.LINK_IS_ADULT}", $"{Instructions.IF} {IfSubTypes.LINK_IS_ADULT} [True/False]", "",
            $"{Instructions.IF}", $"{IfSubTypes.IS_DAY}", $"{Instructions.IF} {IfSubTypes.IS_DAY} [True/False]", "",
            $"{Instructions.IF}", $"{IfSubTypes.IS_TALKING}", $"{Instructions.IF} {IfSubTypes.IS_TALKING} [True/False]", "",
            $"{Instructions.IF}", $"{IfSubTypes.PLAYER_HAS_EMPTY_BOTTLE}", $"{Instructions.IF} {IfSubTypes.PLAYER_HAS_EMPTY_BOTTLE} [True/False]", "",
            $"{Instructions.IF}", $"{IfSubTypes.IN_CUTSCENE}", $"{Instructions.IF} {IfSubTypes.IN_CUTSCENE} [True/False]", "",
            $"{Instructions.IF}", $"{IfSubTypes.TEXTBOX_ON_SCREEN}", $"{Instructions.IF} {IfSubTypes.TEXTBOX_ON_SCREEN} [True/False]", "",
            $"{Instructions.IF}", $"{IfSubTypes.TEXTBOX_DRAWING}", $"{Instructions.IF} {IfSubTypes.TEXTBOX_DRAWING} [True/False]", "",
            $"{Instructions.IF}", $"{IfSubTypes.PLAYER_HAS_MAGIC}", $"{Instructions.IF} {IfSubTypes.PLAYER_HAS_MAGIC} [True/False]", "",
            $"{Instructions.IF}", $"{IfSubTypes.ATTACKED}", $"{Instructions.IF} {IfSubTypes.ATTACKED} [True/False]", "",
            $"{Instructions.IF}", $"{IfSubTypes.PICKUP_IDLE}", $"{Instructions.IF} {IfSubTypes.PICKUP_IDLE} [True/False]", "",
            $"{Instructions.IF}", $"{IfSubTypes.PICKUP_PICKED_UP}", $"{Instructions.IF} {IfSubTypes.PICKUP_PICKED_UP} [True/False]", "",
            $"{Instructions.IF}", $"{IfSubTypes.PICKUP_THROWN}", $"{Instructions.IF} {IfSubTypes.PICKUP_THROWN} [True/False]", "",
            $"{Instructions.IF}", $"{IfSubTypes.PICKUP_LANDED}", $"{Instructions.IF} {IfSubTypes.PICKUP_LANDED} [True/False]", "",

            $"{Instructions.IF}", $"{IfSubTypes.PLAYER_RUPEES}", $"{Instructions.IF} {IfSubTypes.PLAYER_RUPEES} [Operator] [Value]", "",
            $"{Instructions.IF}", $"{IfSubTypes.SCENE_ID}", $"{Instructions.IF} {IfSubTypes.SCENE_ID} [Operator] [Value]", "",
            $"{Instructions.IF}", $"{IfSubTypes.PLAYER_SKULLTULAS}", $"{Instructions.IF} {IfSubTypes.PLAYER_SKULLTULAS} [Operator] [Value]", "",
            $"{Instructions.IF}", $"{IfSubTypes.PATH_NODE}", $"{Instructions.IF} {IfSubTypes.PATH_NODE} [Operator] [Value]", "",
            $"{Instructions.IF}", $"{IfSubTypes.ANIMATION_FRAME}", $"{Instructions.IF} {IfSubTypes.ANIMATION_FRAME} [Operator] [Value]", "",
            $"{Instructions.IF}", $"{IfSubTypes.CUTSCENE_FRAME}", $"{Instructions.IF} {IfSubTypes.CUTSCENE_FRAME} [Operator] [Value]", "",
            $"{Instructions.IF}", $"{IfSubTypes.PLAYER_HEALTH}", $"{Instructions.IF} {IfSubTypes.PLAYER_HEALTH} [Operator] [Value]", "",
            $"{Instructions.IF}", $"{IfSubTypes.PLAYER_BOMBS}", $"{Instructions.IF} {IfSubTypes.PLAYER_BOMBS} [Operator] [Value]", "",
            $"{Instructions.IF}", $"{IfSubTypes.PLAYER_BOMBCHUS}", $"{Instructions.IF} {IfSubTypes.PLAYER_BOMBCHUS} [Operator] [Value]", "",
            $"{Instructions.IF}", $"{IfSubTypes.PLAYER_ARROWS}", $"{Instructions.IF} {IfSubTypes.PLAYER_ARROWS} [Operator] [Value]", "",
            $"{Instructions.IF}", $"{IfSubTypes.PLAYER_DEKUNUTS}", $"{Instructions.IF} {IfSubTypes.PLAYER_DEKUNUTS} [Operator] [Value]", "",
            $"{Instructions.IF}", $"{IfSubTypes.PLAYER_DEKUSTICKS}", $"{Instructions.IF} {IfSubTypes.PLAYER_DEKUSTICKS} [Operator] [Value]", "",
            $"{Instructions.IF}", $"{IfSubTypes.PLAYER_BEANS}", $"{Instructions.IF} {IfSubTypes.PLAYER_BEANS} [Operator] [Value]", "",
            $"{Instructions.IF}", $"{IfSubTypes.PLAYER_SEEDS}", $"{Instructions.IF} {IfSubTypes.PLAYER_SEEDS} [Operator] [Value]", "",

            $"{Instructions.IF}", $"{IfSubTypes.EXT_VAR}", $"{Instructions.IF} {IfSubTypes.EXT_VAR} [ActorID] [ExtVarID] [Operator] [Value]", "",

            $"{Instructions.IF}", $"{IfSubTypes.STICK_X}", $"{Instructions.IF} {IfSubTypes.STICK_X} [Operator] [Value]", "",
            $"{Instructions.IF}", $"{IfSubTypes.STICK_Y}", $"{Instructions.IF} {IfSubTypes.STICK_Y} [Operator] [Value]", "",

            $"{Instructions.IF}", $"{IfSubTypes.ITEM_BEING_TRADED}", $"{Instructions.IF} {IfSubTypes.ITEM_BEING_TRADED} [TradeItem]", "",
            $"{Instructions.IF}", $"{IfSubTypes.TRADE_STATUS}", $"{Instructions.IF} {IfSubTypes.TRADE_STATUS} [Success|Failure|Talked To]", "",
            $"{Instructions.IF}", $"{IfSubTypes.PLAYER_MASK}", $"{Instructions.IF} {IfSubTypes.PLAYER_MASK} [PlayerMask]", "",
            $"{Instructions.IF}", $"{IfSubTypes.ANIMATION}", $"{Instructions.IF} {IfSubTypes.ANIMATION} [AnimationName]", "",
            $"{Instructions.IF}", $"{IfSubTypes.TIME_OF_DAY}", $"{Instructions.IF} {IfSubTypes.TIME_OF_DAY} [Operator] [hh:mm]", "",
            $"{Instructions.IF}", $"{IfSubTypes.PLAYER_HAS_INVENTORY_ITEM}", $"{Instructions.IF} {IfSubTypes.PLAYER_HAS_INVENTORY_ITEM} [InventoryItem]", "",
            $"{Instructions.IF}", $"{IfSubTypes.PLAYER_HAS_QUEST_ITEM}", $"{Instructions.IF} {IfSubTypes.PLAYER_HAS_QUEST_ITEM} [QuestItem]", "",
            $"{Instructions.IF}", $"{IfSubTypes.PLAYER_HAS_DUNGEON_ITEM}", $"{Instructions.IF} {IfSubTypes.PLAYER_HAS_DUNGEON_ITEM} [DungeonItem] [DungeonId]", "",
            $"{Instructions.IF}", $"{IfSubTypes.BUTTON_PRESSED}", $"{Instructions.IF} {IfSubTypes.BUTTON_PRESSED} [Button]", "",
            $"{Instructions.IF}", $"{IfSubTypes.BUTTON_HELD}", $"{Instructions.IF} {IfSubTypes.BUTTON_HELD} [Button]", "",
            $"{Instructions.IF}", $"{IfSubTypes.TARGETTED}", $"{Instructions.IF} {IfSubTypes.TARGETTED} [True/False]", "",

            $"{Instructions.IF}", $"{IfSubTypes.DISTANCE_FROM_PLAYER}", $"{Instructions.IF} {IfSubTypes.DISTANCE_FROM_PLAYER} [Operator] [Value]", "",
            $"{Instructions.IF}", $"{IfSubTypes.LENS_OF_TRUTH_ON}", $"{Instructions.IF} {IfSubTypes.LENS_OF_TRUTH_ON} [True/False]", "",
            $"{Instructions.IF}", $"{IfSubTypes.DAMAGED_BY}", $"{Instructions.IF} {IfSubTypes.DAMAGED_BY} [DamageType]", "",
            $"{Instructions.IF}", $"{IfSubTypes.ROOM_ID}", $"{Instructions.IF} {IfSubTypes.ROOM_ID} [Operator] [Value]", "",

            $"{Instructions.IF}", $"{IfWhileAwaitSetRamSubTypes.VAR}", $"{Instructions.IF} {IfWhileAwaitSetRamSubTypes.VAR}.[VarID] [Operator] [Value]", "",
            $"{Instructions.IF}", $"{IfWhileAwaitSetRamSubTypes.VARF}", $"{Instructions.IF} {IfWhileAwaitSetRamSubTypes.VARF}.[VarID] [Operator] [Value]", "",
            $"{Instructions.IF}", $"{IfWhileAwaitSetRamSubTypes.ACTOR8}", $"{Instructions.IF} {IfWhileAwaitSetRamSubTypes.ACTOR8}.[Address] [Operator] [Value]", "",
            $"{Instructions.IF}", $"{IfWhileAwaitSetRamSubTypes.ACTOR16}", $"{Instructions.IF} {IfWhileAwaitSetRamSubTypes.ACTOR16}.[Address] [Operator] [Value]", "",
            $"{Instructions.IF}", $"{IfWhileAwaitSetRamSubTypes.ACTOR32}", $"{Instructions.IF} {IfWhileAwaitSetRamSubTypes.ACTOR16}.[Address] [Operator] [Value]", "",
            $"{Instructions.IF}", $"{IfWhileAwaitSetRamSubTypes.ACTORF}", $"{Instructions.IF} {IfWhileAwaitSetRamSubTypes.ACTORF}.[Address] [Operator] [Value]", "",
            $"{Instructions.IF}", $"{IfWhileAwaitSetRamSubTypes.SAVE8}", $"{Instructions.IF} {IfWhileAwaitSetRamSubTypes.SAVE8}.[Address] [Operator] [Value]", "",
            $"{Instructions.IF}", $"{IfWhileAwaitSetRamSubTypes.SAVE16}", $"{Instructions.IF} {IfWhileAwaitSetRamSubTypes.SAVE16}.[Address] [Operator] [Value]", "",
            $"{Instructions.IF}", $"{IfWhileAwaitSetRamSubTypes.SAVE32}", $"{Instructions.IF} {IfWhileAwaitSetRamSubTypes.SAVE32}.[Address] [Operator] [Value]", "",
            $"{Instructions.IF}", $"{IfWhileAwaitSetRamSubTypes.SAVEF}", $"{Instructions.IF} {IfWhileAwaitSetRamSubTypes.SAVEF}.[Address] [Operator] [Value]", "",
            $"{Instructions.IF}", $"{IfWhileAwaitSetRamSubTypes.GLOBAL8}", $"{Instructions.IF} {IfWhileAwaitSetRamSubTypes.GLOBAL8}.[Address] [Operator] [Value]", "",
            $"{Instructions.IF}", $"{IfWhileAwaitSetRamSubTypes.GLOBAL16}", $"{Instructions.IF} {IfWhileAwaitSetRamSubTypes.GLOBAL16}.[Address] [Operator] [Value]", "",
            $"{Instructions.IF}", $"{IfWhileAwaitSetRamSubTypes.GLOBAL32}", $"{Instructions.IF} {IfWhileAwaitSetRamSubTypes.GLOBAL32}.[Address] [Operator] [Value]", "",
            $"{Instructions.IF}", $"{IfWhileAwaitSetRamSubTypes.GLOBALF}", $"{Instructions.IF} {IfWhileAwaitSetRamSubTypes.GLOBALF}.[Address] [Operator] [Value]", "",
            $"{Instructions.IF}", $"{IfWhileAwaitSetRamSubTypes.RANDOM}", $"{Instructions.IF} {IfWhileAwaitSetRamSubTypes.RANDOM}.[MinimumVal]->[MaximumVal] [Operator] [Value]", "",
        };
