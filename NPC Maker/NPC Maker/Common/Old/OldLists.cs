...
namespace NPC_Maker
{
    public static class OldLists
    {
        ...
        {
            {Enum.GetName(typeof(OldLists.InstructionIDs), (int)OldLists.InstructionIDs.IF), Enum.GetNames(typeof(OldLists.IfSubTypes)) },
            {Enum.GetName(typeof(OldLists.InstructionIDs), (int)OldLists.InstructionIDs.SET), Enum.GetNames(typeof(OldLists.SetSubTypes)) },
            {Enum.GetName(typeof(OldLists.InstructionIDs), (int)OldLists.InstructionIDs.WAITFOR), Enum.GetNames(typeof(OldLists.WaitForSubTypes)) },
            {Enum.GetName(typeof(OldLists.InstructionIDs), (int)OldLists.InstructionIDs.PLAY), Enum.GetNames(typeof(OldLists.PlaySubtypes)) },
            {Enum.GetName(typeof(OldLists.InstructionIDs), (int)OldLists.InstructionIDs.KILL), Enum.GetNames(typeof(OldLists.KillSubtypes)) },
            {Enum.GetName(typeof(OldLists.InstructionIDs), (int)OldLists.InstructionIDs.TURN), Enum.GetNames(typeof(OldLists.TurnTypeSubtypes)) },
            {Enum.GetName(typeof(OldLists.InstructionIDs), (int)OldLists.InstructionIDs.SCRIPT_CHANGE), Enum.GetNames(typeof(OldLists.ScriptOverwriteTypes)) },
        };
        ...
        private static List<string> GetKeyValues()
        {
            ...
            Values.AddRange(Enum.GetNames(typeof(OldLists.MovementStyles)));
            Values.AddRange(Enum.GetNames(typeof(OldLists.DListVisibilityTypes)));
            Values.AddRange(Enum.GetNames(typeof(OldLists.LookTypes)));
            Values.AddRange(Enum.GetNames(typeof(OldLists.Segments)));
